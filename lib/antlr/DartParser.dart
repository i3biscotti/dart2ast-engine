...
class DartParser extends Parser {
  ...
  static const int TOKEN_WS = 1, TOKEN_VAR = 2, TOKEN_FINAL = 3, TOKEN_CONST = 4, 
                   ...
                   TOKEN_BOOLLIT = 16, TOKEN_STRINGLIT = 17, TOKEN_UnterminatedStringLiteral = 18, 
                   ...
                   TOKEN_PAREN_CLOSE = 33, TOKEN_GRAPH_OPEN = 34, TOKEN_GRAPH_CLOSE = 35, 
                   TOKEN_COMMA = 36, TOKEN_DOT = 37, TOKEN_ID = 38;
  ...
  static final List<String?> _SYMBOLIC_NAMES = [
      ...
      "BOOLLIT", "STRINGLIT", "UnterminatedStringLiteral", "PLUS", "MINUS", 
      "DIVISION", "TIMES", "MODULE", "GREATER_EQUAL_THAN", "LOWER_EQUAL_THAN", 
      "GREATER_THAN", "LOWER_THAN", "EQUAL", "AND", "OR", "NOT", "PAREN_OPEN", 
      "PAREN_CLOSE", "GRAPH_OPEN", "GRAPH_CLOSE", "COMMA", "DOT", "ID"
  ];
  ...
  DartFileContext dartFile() {
    ...
    try {
      ...
      do {
        ...
        errorHandler.sync(this);
        _la = tokenStream.LA(1)!;
      } while ((((_la) & ~0x3f) == 0 && ((1 << _la) & 274877910972) != 0));
      state = 23;
      match(TOKEN_EOF);
  ...
  ExpressionContext expression([int _p = 0]) {
    ...
    try {
      ...
      case 10:
        ...
        errorHandler.sync(this);
        _la = tokenStream.LA(1)!;
        if ((((_la) & ~0x3f) == 0 && ((1 << _la) & 281322176512) != 0)) {
          state = 97;
          expression(0);
        }
  ...
  static const List<int> _serializedATN = [
      ...
      1,0,0,0,29,26,1,0,0,0,29,28,1,0,0,0,30,31,1,0,0,0,31,32,5,38,0,0,32,
      ...
      38,0,0,41,42,5,12,0,0,42,43,3,6,3,0,43,44,5,13,0,0,44,62,1,0,0,0,45,
      47,5,4,0,0,46,48,3,4,2,0,47,46,1,0,0,0,47,48,1,0,0,0,48,49,1,0,0,0,
      49,50,5,38,0,0,50,51,5,12,0,0,51,52,3,6,3,0,52,53,5,13,0,0,53,62,1,
      0,0,0,54,55,5,38,0,0,55,56,5,12,0,0,56,57,3,6,3,0,57,58,5,13,0,0,58,
      ...
      5,11,0,0,68,70,5,38,0,0,69,63,1,0,0,0,69,64,1,0,0,0,69,65,1,0,0,0,
      ...
      76,77,5,20,0,0,77,121,3,6,3,8,78,79,5,19,0,0,79,121,3,6,3,7,80,81,
      5,31,0,0,81,121,3,6,3,6,82,83,5,32,0,0,83,84,3,6,3,0,84,85,5,32,0,
      0,85,121,1,0,0,0,86,121,5,38,0,0,87,88,5,38,0,0,88,94,5,32,0,0,89,
      90,3,6,3,0,90,91,5,36,0,0,91,93,1,0,0,0,92,89,1,0,0,0,93,96,1,0,0,
      0,94,92,1,0,0,0,94,95,1,0,0,0,95,98,1,0,0,0,96,94,1,0,0,0,97,99,3,
      6,3,0,98,97,1,0,0,0,98,99,1,0,0,0,99,100,1,0,0,0,100,121,5,33,0,0,
      101,102,5,38,0,0,102,103,5,37,0,0,103,121,5,38,0,0,104,105,5,38,0,
