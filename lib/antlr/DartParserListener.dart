...
abstract class DartParserListener extends ParseTreeListener {
  ...
  /// Enter a parse tree produced by the [OutputExpression]
  /// labeled alternative in [file.parserName>.expression].
  /// [ctx] the parse tree
  void enterOutputExpression(OutputExpressionContext ctx);
  /// Exit a parse tree produced by the [OutputExpression]
  /// labeled alternative in [DartParser.expression].
  /// [ctx] the parse tree
  void exitOutputExpression(OutputExpressionContext ctx);
  ...
  /// Enter a parse tree produced by the [VarDeclarationForStatement]
  /// labeled alternative in [file.parserName>.forInitOrIncrementStatement].
  /// [ctx] the parse tree
  void enterVarDeclarationForStatement(VarDeclarationForStatementContext ctx);
  /// Exit a parse tree produced by the [VarDeclarationForStatement]
  /// labeled alternative in [DartParser.forInitOrIncrementStatement].
  /// [ctx] the parse tree
  void exitVarDeclarationForStatement(VarDeclarationForStatementContext ctx);

  /// Enter a parse tree produced by the [AssignmentForStatement]
  /// labeled alternative in [file.parserName>.forInitOrIncrementStatement].
  /// [ctx] the parse tree
  void enterAssignmentForStatement(AssignmentForStatementContext ctx);
  /// Exit a parse tree produced by the [AssignmentForStatement]
  /// labeled alternative in [DartParser.forInitOrIncrementStatement].
  /// [ctx] the parse tree
  void exitAssignmentForStatement(AssignmentForStatementContext ctx);

  /// Enter a parse tree produced by the [ExpressionForStatement]
  /// labeled alternative in [file.parserName>.forInitOrIncrementStatement].
  /// [ctx] the parse tree
  void enterExpressionForStatement(ExpressionForStatementContext ctx);
  /// Exit a parse tree produced by the [ExpressionForStatement]
  /// labeled alternative in [DartParser.forInitOrIncrementStatement].
  /// [ctx] the parse tree
  void exitExpressionForStatement(ExpressionForStatementContext ctx);
